...
public class ChessMatch {
	...
	private Board board;
	private boolean check; //como padrao sempre começa como falso
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		return (ChessPiece)capturedPiece; //downcasting da peça capturada do tipo piece para chesspiece
	}
	...
	private void validateSourcePosition(Position position) {
		//if (!board.thereIsAPiece(position){ por algum motivo não funciona
	...
	private void initialSetup() {//responsável por iniciar a partidade xadrez colocando as peças
